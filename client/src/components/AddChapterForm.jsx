...
import { novelList } from '../utility/itemList';
...
const AddChapterForm = () => {
  ...
  return (
    <>
      <section className="bg-white border border-slate-900 mt-5 mb-5 rounded-md p-10 shadow-lg shadow-slate-600 dark:bg-gray-900 ">

...
const Category = ({ category }) => {
  const { loading, novels, total, pagination } = useSelector(
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <div className="relative overflow-x-auto mt-5 mb-5 shadow-md sm:rounded-lg">
            ...
            {novels && (
              <LatestPagination total={total} pagination={pagination} />
            )}
          </div>
        </>
      )}
